...
use crate::model::models::Gemini::{GeminiClient, PromptInput};

// A wrapper function for EY-Ai integration
// it will handle the key management and request generation
pub async fn eyai_wrapper(State(gemini): State<GeminiClient>, Json(input): Json<PromptInput>) -> Json<Value> {
